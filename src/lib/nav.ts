...
/* ─────────────────────────────────────────────────────────────
   ...
   Los dos primeros se eligen en el login público. El tercero entra
   por una ruta aparte que no está enlazada desde ningún lado:

       /acceso-interno        usuario: admin    clave: 1234

   Sin backend todavía: el rol solo decide qué navegación y qué
   pantallas se montan.
   ───────────────────────────────────────────────────────────── */
