-- ============================================================
-- ÍNDICE PARA FILTRO POR ESPECIE
-- ============================================================

create index mascotas_perdidas_especie_idx
...
-- ============================================================
-- ELIMINAR VERSIÓN ANTERIOR DE LA RPC
-- ============================================================

drop function if exists public.buscar_mascotas_perdidas_cercanas(
    double precision,
    double precision,
    double precision,
    uuid
...
-- CON FILTRO OPCIONAL POR ESPECIE
-- ============================================================
...
begin
    ...
    where
        ...
        and (
            p_especie is null
            or lower(mp.especie) = lower(trim(p_especie))
        )
